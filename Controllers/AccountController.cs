        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    userM.AddToRole(user.Id, "Registrovan");
                    await SignInManager.SignInAsync(user, isPersistent:false, rememberBrowser:false);

                    // Sending e-mail to newly registred user
                    ...
                    message.Subject = "Welcome " + model.Name + " " + model.Surname + " to IEP Auction!";
                    message.Body = "You have successfully registred on IEP Auction!" + "<br/>" +
                                    "---------------------------------------------------------" + "<br/>" +
                                    "Name:\t\t" + model.Name + "<br/>" +
                    ...
                    {
                        logger.Error("AccountController // Register() // Email sending to new user " + e.ToString());
                    }
